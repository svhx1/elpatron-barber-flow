// LoginView - Tela de login/cadastro com suporte a email/senha e Google (visual)
      ...
      >
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-2xl border border-border p-8">
          ...
          <div className="space-y-4">
            ...
            {!isSignUp && (
              <button className="text-xs text-muted-foreground hover:text-accent font-body transition-colors">
                Esqueceu a senha?
              </button>
            )}

            <button className="w-full py-3 rounded-xl gold-gradient text-accent-foreground font-body text-sm font-bold hover:opacity-90 transition-opacity">
              {isSignUp ? "Criar Conta" : "Entrar"}
            </button>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card/80 px-3 text-muted-foreground font-body">ou</span>
            </div>
          </div>

          <button className="w-full py-3 rounded-xl border border-border bg-background hover:bg-muted transition-colors flex items-center justify-center gap-3">
            ...
            <span className="text-foreground font-body text-sm font-medium">Entrar com Google</span>
          </button>
